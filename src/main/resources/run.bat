...
set CLASSPATH=%CLASSPATH%;./../lib/iText-2.1.3.jar
set CLASSPATH=%CLASSPATH%;./../lib/jade.jar
set CLASSPATH=%CLASSPATH%;./../lib/jadeTools.jar
set CLASSPATH=%CLASSPATH%;./../lib/jcommon-1.0.14.jar
set CLASSPATH=%CLASSPATH%;./../lib/jfreechart-1.0.11.jar
set CLASSPATH=%CLASSPATH%;./../lib/jfreechart-1.0.11-experimental.jar
set CLASSPATH=%CLASSPATH%;./../lib/jfreechart-1.0.11-swt.jar
